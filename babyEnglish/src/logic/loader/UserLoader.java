...
public class UserLoader extends DBLoaderEx<bs_user> {
	...
	public  void reset() {
		...
		Iterator<bs_user> iterator = this.m_Datas.iterator();
		long i=301989888;
		while (iterator.hasNext()) {
		i+=1000;
			bs_user bs_group = (bs_user) iterator.next();
	/*		bs_group.RoleID.Set(i);*/
			DBMgr.ExecuteSQL("update bs_user  set roleid="+i+" where roleid="+bs_group.RoleID.Get());
