...
//	}
	...
	@Override
	@RFC(ID = 4)
	public void RetrievePass(@PU MyUser p_user, @PS String tel, @PI int code,
			@PS String pass) {
		// TODO Auto-generated method stub
	...
	@Override
	@RFC(ID = 20)
	public void AddGroup(@PU MyUser p_user, @PS String area,
	...
	@Override
	@RFC(ID = 22)
	public void GetUserList(@PU MyUser p_user, @PI int page, @PI int groupId, @PS String area, @PS String Province, @PS String city, @PS String tel) {
		// TODO Auto-generated method stub
	...
	@Override
	@RFC(ID = 25)
	public void UpdateGroup(@PU MyUser p_user, @PI int groupId, @PS String area,
			@PS String Province, @PS String city, @PS String name,
			@PS String pass, @PI int anthLevel) {
		// TODO Auto-generated method stub
	...
	@Override
	@RFC(ID = 24)
	public void AddMsg(@PU MyUser p_user, @PI int type, @PS String title,
		...
		MessageLoader loader = (MessageLoader)LoaderManager.getInstance().getLoader(LoaderManager.Message);
		int msgId = loader.addSystemMessage(type, title, content, isTop, topTime, showTime, area, groupId, linkurl, imgurl);
	...
	@Override
	@RFC(ID = 26)
	public void AddUser(@PU MyUser p_user, @PS String tel, @PS String mail,
			@PS String area, @PS String name, @PS String pass, @PI int money,
			@PI int groupId, @PS String groupName, @PS String province, @PS String city) {
		// TODO Auto-generated method stub
		GroupLoader loader = (GroupLoader) LoaderManager.getInstance().getLoader(LoaderManager.Group);
	...
	@Override
	@RFC(ID = 31)
	public void UpdateUser(@PU MyUser p_user, @PL long userId, @PS String area,
			@PS String Province, @PS String city, @PS String name,
		...
		int oldGroupId = center.updateUser(userId, area,
				Province, city, name,
				mail, isEbl, groupId,
				groupName, age);
		if(oldGroupId == -1){
	...
	@Override
	@RFC(ID = 37)
	public void UpdateGroupField(@PU MyUser p_user, @PI int groupId, @PS String Area,
			@PS String Province, @PS String City, @PS String Tel,
			@PS String Addr, @PS String Name, @PS String Password,
			@PI int Number, @PI int Income, @PI int ChargeNum,
			@PI int ChargeCount, @PI int LostUserCount, @PI int AddUserCount,
			@PI int DownloadCount, @PI int CardUsedCount1,
			@PI int CardUsedCount2, @PI int FreeUsedCount1, @PI int Auth,
		...
		PlayerCenterData center = p_user.getCenterData();
		center.updateGroupFields(groupId, Area, Province, City, Tel, Addr, Name, Password, Number, Income, ChargeNum, ChargeCount, LostUserCount, AddUserCount, DownloadCount, CardUsedCount1, CardUsedCount2, FreeUsedCount1, Auth, isSelf, Parent);
		send.Add(1);
		send.Send(p_user);
	}
	...
	@Override
	@RFC(ID = 38)
	public void ModifyUser(@PU MyUser p_user, @PL long userId, @PS String area,
			@PS String Province, @PS String city, @PS String name,
			@PS String mail, @PI int isEbl, @PI int groupId,
			@PS String groupName, @PI int age) {
		// TODO Auto-generated method stub
		// TODO Auto-generated method stub
				...
				boolean ret = center.modifyUser(userId, area,
						Province, city, name,
						mail, isEbl, groupId,
						groupName, age);
				send.Add(ret ? 1 : 0);
