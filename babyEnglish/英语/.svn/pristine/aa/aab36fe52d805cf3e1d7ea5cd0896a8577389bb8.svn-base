...
public static class _ConnectionManager
{
	...
	static public void CenterImpl_UpdateUser(this ConnectionManager mgr, long userId, string area, string Province, string city, string name, string mail, int isEbl, int groupId, string groupName, int age)
	{
		PacketBuffer.GetInstance().Clear().SetObjMethod(3,31).Add(userId).Add(area).Add(Province).Add(city).Add(name).Add(mail).Add(isEbl).Add(groupId).Add(groupName).Add(age).Send(mgr);
	}
	...
	static public void CenterImpl_ModifyUser(this ConnectionManager mgr, long userId, string area, string Province, string city, string name, string mail, int isEbl, int groupId, string groupName, int age)
	{
		PacketBuffer.GetInstance().Clear().SetObjMethod(3,38).Add(userId).Add(area).Add(Province).Add(city).Add(name).Add(mail).Add(isEbl).Add(groupId).Add(groupName).Add(age).Send(mgr);
	}
