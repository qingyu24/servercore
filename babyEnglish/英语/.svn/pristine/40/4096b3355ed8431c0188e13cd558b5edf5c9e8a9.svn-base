...
public class RFCFn
{
	...
	public static void CenterImpl_ModifyUser(Robot r, long userId, String area, String Province, String city, String name, String mail, int isEbl, int groupId, String groupName, int age)
	{
		r.GetSendBuffer().Clear().AddID(3,38).Add(userId).Add(area).Add(Province).Add(city).Add(name).Add(mail).Add(isEbl).Add(groupId).Add(groupName).Add(age).Send(r.GetLink());
	}
