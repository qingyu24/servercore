...
public class RFCFn
{
	...
	public static void CenterImpl_UpdateUser(Robot r, long userId, String area, String Province, String city, String name, String mail, int isEbl, int groupId, String groupName, int age, String tel)
	{
		r.GetSendBuffer().Clear().AddID(3,31).Add(userId).Add(area).Add(Province).Add(city).Add(name).Add(mail).Add(isEbl).Add(groupId).Add(groupName).Add(age).Add(tel).Send(r.GetLink());
	}
